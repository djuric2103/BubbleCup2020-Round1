...
struct Treap {
    ...
    Treap() {
        notFound = create_treap_node(-1, -1, NULL);
        root = NULL;
    }
...
void changeLast() {
    ...
    t.insert(create_treap_node(new_node));
}
